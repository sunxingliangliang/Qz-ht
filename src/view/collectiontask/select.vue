    ...
    <el-table :data="Scenes" border style="width: 100%">
      ...
      <el-table-column label="区域\行业" >
        <template slot-scope="scope">
          ...
          <span v-if="scope.row.type==='2'">{{scope.row.industryParent}}\{{scope.row.industry}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="cj" label="场景" >
        <template slot-scope="scope">
          <span v-if="scope.row.type==='1'">{{scope.row.regionTypeParent}}\{{scope.row.regionType}}</span>
          <span v-if="scope.row.type==='2'">{{scope.row.industryTypeParent}}\{{scope.row.industryType}}</span>
        </template>
      </el-table-column>
