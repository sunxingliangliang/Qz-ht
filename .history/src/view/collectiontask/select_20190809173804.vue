    ...
    <el-table :data="client" border style="width: 100%">
      ...
      <el-table-column label="客户类型">
        <template slot-scope="scope">
          <span v-if="scope.row.proxyType===1"></span>
          <span v-if="scope.row.proxyType===2"></span>
          <span v-if="scope.row.proxyType===3"></span>
          <span v-if="scope.row.proxyType===4"></span>
          <span v-if="scope.row.proxyType===5"></span>
        </template>
      </el-table-column>
