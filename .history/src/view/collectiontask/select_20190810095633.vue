...
export default {
  ...
  methods: {
    ...
    renwuzb (row) {
      ...
      // }
      // this.adjunction()
      this.$jsonp(`http://api.map.baidu.com/geocoder/v2/?ak=1IGwblSXzAV0yxzCq0ZGdYoixoreCQwS&callback=renderReverse&location=${row.lat},${this.center.lng}&output=json&pois=1 `).then(res => {
        // var {code,data}=res.data
