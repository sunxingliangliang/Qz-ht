...
export default {
  ...
  methods: {
    ...
    getList () {
      this.$http.get(`modules/fixed/adminList?size=${this.sizes}&page=${this.pages}`, {
        params: {
          size: this.sizes,
          page: this.pages,
        }
    ...
    search () {
      ...
      if (this.value1 === null) {
        console.log('1')
        this.value1 = ''
        this.$http.get(`modules/fixed/adminList?createTime=${this.value1}&search=${this.input}&proxy=${this.value2}&status=${this.value}&size=${this.sizes}&page=${this.pages}`, {
        params: {
          size: this.sizes,
          page: this.pages,
