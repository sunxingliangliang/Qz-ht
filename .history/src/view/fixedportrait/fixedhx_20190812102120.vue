      ...
      <el-tab-pane label="客群来源" name="third1">
        ...
        <div>
          ...
          <div :class="$style.f_hx2">
            <div
              id="myChart26"
              style="position: static; width:49%;height:300px; display: inline-block;"
            ></div>
...
export default {
  ...
  methods: {
    ...
    getList () {
      ...
      this.$http.post(`pc/fixedPortrait/selectAddress`, {params:
          {
            taskId: id,
            type: '1'
          }
    ...
    getKequn () {
      let id = this.id
      this.$http.post(`pc/fixedPortrait/selectCustomerAddr`, { taskId: id, aireType: 1 }{params:
          {
            taskId: id,
            type: '1'
          }
