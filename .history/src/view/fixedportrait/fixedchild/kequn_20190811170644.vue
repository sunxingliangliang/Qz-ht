...
export default {
  ...
  methods: {
    ...
    dianji3 () {
      let info = {}
      if (this.value1 === ''&&this.radio12!='4'&&this.radio12!='5') {
        info = {
          'taskId': this.id,
      ...
      } else if(this.value1 != ''&&this.radio12!='4'&&this.radio12!='5') {
        info = {
          'taskId': this.id,
          "startDate": this.value1[0],
          'endDate': this.value1[1],
      ...
      }else if(this.value1 === ''&&this.radio12==='4'){
        info={
          'taskId': this.id,
          "startDate": this.value1[0],
          'endDate': this.value1[1],
      ...
      }else if(this.value1 === ''&&this.radio12==='5'){
        info={
          'taskId': this.id,
          "startDate": this.value1[0],
          'endDate': this.value1[1],
