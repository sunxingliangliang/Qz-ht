<template>
  <div>
    ...
    <div :class="$style.f_hx1">
      ...
      <div id="myChart488" style="position: static; width:280px;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx1">
      <span :class="$style.f_mc">{{mc1}}</span>
      <div id="myChart489" style="position: static; width:280px;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx1">
    ...
    <div :class="$style.f_hx1">
      ...
      <div id="myChart44" style="position: static; width:280px;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx1">
      <span :class="$style.f_mc">{{mc7}}</span>
      <div id="myChart45" style="position: static; width:280px;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx1">
      <span :class="$style.f_mc">{{mc8}}</span>
      <div id="myChart46" style="position: static; width:280px;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx1">
      <span :class="$style.f_mc">{{mc9}}</span>
      <div id="myChart47" style="position: static; width:280px;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx1">
      <span :class="$style.f_mc">{{mc10}}</span>
      <div id="myChart48" style="position: static; width:280px;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx1">
      <span :class="$style.f_mc">{{mc11}}</span>
      <div id="myChart49" style="position: static; width:280px;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx1">
      <span :class="$style.f_mc">{{mc12}}</span>
      <div id="myChart50" style="position: static; width:280px;height:300px;left:4%;"></div>
    </div>
    <br>

    <div :class="$style.f_hx3">
      <div id="myChart51" style="position: static; width:900px;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx3">
      <div id="myChart52" style="position: static; width:100%;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx3">
      <div id="myChart53" style="position: static; width:100%;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx3">
      <div id="myChart54" style="position: static; width:100%;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx3">
      <div id="myChart55" style="position: static; width:100%;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx3">
      <div id="myChart56" style="position: static; width:100%;height:300px;left:4%;"></div>
    </div>
    <div :class="$style.f_hx3">
      <div id="myChart57" style="position: static; width:100%;height:300px;left:4%;"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    getList () {
      this.$http.get(`pc/fixedPortrait/selectClothing?taskId=${this.id}`).then(res => {
    ...
    dianji3 () {
      ...
      console.log(this.checkboxGroup1.join(','))
        this.$http.get(`pc/fixedPortrait/selectClothing?taskId=${this.id}&dateStr4Start=${this.value1[0]}&dateStr4Start=${this.value1[1]}`).then(res => {
        var { code, data } = res.data
        if (code === 1000) {
          this.drawLine9(data);
          this.drawLine10(data);
    ...
    drawLine9 (data) {
      ...
      let myChart = this.$echarts.init(document.getElementById("myChart488"));
      let option = {
    ...
    drawLine10 (data) {
      ...
      let myChart = this.$echarts.init(document.getElementById("myChart489"));
      let option = {
    ...
    drawLine17 (data) {
      ...
      let myChart = this.$echarts.init(document.getElementById("myChart51"));
      let option = {
        title: {
          text: '购买习惯'
        },
    ...
    drawLine18 (data) {
      ...
      let myChart = this.$echarts.init(document.getElementById("myChart52"));
      let option = {
        title: {
          text: '男装品牌'
        },
    ...
    drawLine19 (data) {
      ...
      let myChart = this.$echarts.init(document.getElementById("myChart53"));
      let option = {
        title: {
          text: '男装品牌偏好'
        },
    ...
    drawLine20 (data) {
      ...
      let myChart = this.$echarts.init(document.getElementById("myChart54"));
      let option = {
        title: {
          text: '运动户外品牌偏好'
        },
    ...
    drawLine21 (data) {
      ...
      let myChart = this.$echarts.init(document.getElementById("myChart55"));
      let option = {
        title: {
          text: '内衣家居品牌偏好'
        },
    ...
    drawLine22 (data) {
      ...
      let myChart = this.$echarts.init(document.getElementById("myChart56"));
      let option = {
        title: {
          text: '女鞋品牌偏好'
        },
    ...
    drawLine25 (data) {
      ...
      let myChart = this.$echarts.init(document.getElementById("myChart57"));
      let option = {
        title: {
          text: '女装品牌偏好'
        },
