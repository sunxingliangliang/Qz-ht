<template>
  <div>
    <el-row :class="$style.f_row1">
      ...
      <el-checkbox-group v-model="gender1" @change="dj1" :class="$style.f_dx">
        <el-checkbox-button
    ...
    <el-row :class="$style.f_row1">
      ...
      <el-checkbox-group v-model="age1" @change="dj" :class="$style.f_dx">
        <el-checkbox-button
          v-for="(city1,i) in genderoptions1"
          style="margin-left:20px;"
          :label="city1.value"
          :value="city1.value"
          :key="i"
...
export default {
  data () {
    return {
      ...
      ageoptions1: age,
      Educationoptions2: Education,
      genderoptions3: Salary,
      genderoptions4: infant,
      genderoptions5: region,
      radio1: '',
      radio2: '',
      radio3: '',
      radio4: '',
