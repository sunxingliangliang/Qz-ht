  ...
  methods: {
    ...
    search () {
      ...
      if (this.value1 === null) {
        console.log('1')
        this.value1 = ''
        this.$http.get(`modules/orderData?createTime=${this.value1}&search=${this.input}&proxyType=${this.value}&status=${this.value2}&size=${this.sizes}&page=${this.pages}`, {
        params: {
          size: this.sizes,
          createTime: this.pages,
          search: this.name,
