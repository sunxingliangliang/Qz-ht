  ...
  methods: {
    ...
    search () {
      ...
      if (this.value1 === null) {
        ...
        this.$http.get(`modules/orderData?createTime=${this.value1}&search=${this.input}&proxyType=${this.value}&status=${this.value2}&size=${this.sizes}&page=${this.pages}`,{params:{
          createTime:this.value1,
