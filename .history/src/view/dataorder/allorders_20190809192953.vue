    ...
    <div>
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column  label="客户类型">
          <template slot-scope="scope">
            {{scope.row.}}
            <span v-if="scope.row.proxyType===1">大客户</span>
            <span v-if="scope.row.proxyType===2">省级代理商</span>
            <span v-if="scope.row.proxyType===3">市级代理商</span>
            <span v-if="scope.row.proxyType===4">一般代理商</span>
          </template>
        </el-table-column>
