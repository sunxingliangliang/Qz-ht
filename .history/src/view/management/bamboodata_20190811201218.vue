      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="name" label="类型" >
          <template slot-scope="scope">
            ...
            <span v-if="scope.row.type===1">数据收益</span>
            <span v-if="scope.row.type===1">任务奖励</span>
            <span v-if="scope.row.type===1">订购数据</span>
            <span v-if="scope.row.type===1">数据画像</span>
            <span v-if="scope.row.type===1">固定画像</span>
          </template>
        </el-table-column>
