  ...
  <div>
    ...
    <el-row>
      <el-col :span="7" style="margin-left:70px">
        ...
        <el-select v-model="leixing" :class="$style.f_khipt" @change="dj(value)" placeholder="请选择">
          <el-option v-for="item in xzlx" :key="item.value" :label="item.label" :value="item.value"></el-option>
        </el-select>
      </el-col>
      <el-col :span="8">
        <span :class="$style.f_khmc">区域:</span>
        <el-input placeholder="请输入内容" :class="$style.f_khipt" v-model="input" clearable></el-input>
      </el-col>
    </el-row>
