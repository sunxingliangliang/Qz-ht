  ...
  <div>
    ...
    <el-row>
      ...
      <el-col :span="5" v-if="leixing!=4&leixing!=''">
        ...
        <el-select v-model="province" :class="$style.f_khipt" @change="provinceevent" placeholder="请选择">
          <el-option
      ...
      <el-col :span="5" v-if="leixing!=4&leixing!=''&leixing!=1">
        ...
        <el-select v-model="city" :class="$style.f_khipt" @change="cityevent(value)" placeholder="请选择">
